...
Biquad::Biquad(const char *name) {
    ...
    arm_biquad_cascade_df2T_init_f32(this->filter_instance_L, 1, new float32_t[5], new float32_t[2]);
    arm_biquad_cascade_df2T_init_f32(this->filter_instance_R, 1, new float32_t[5], new float32_t[2]);
    ...
    this->parameters[1] = new Parameter("Frequency", "Hz", 100, 20000, 100, 5000);
    this->parameters[2] = new Parameter("Q", "", 100, 5000, 100, 1000);
    this->parameters[3] = new Parameter("Peak gain", "", -10000, 10000, 500, 0);
...
void Biquad::UpdateParameters() {
    ...
    this->peak_gain = (float32_t)this->parameters[3]->GetValue() * 0.001;
